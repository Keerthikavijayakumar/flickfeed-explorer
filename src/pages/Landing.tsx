        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Button className="btn-cta px-8 py-6 text-lg" onClick={() => navigate('/browse')}>Start Watching</Button>
              <Button variant="secondary" className="px-8 py-6 text-lg" onClick={() => navigate('/login')}>Sign In</Button>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative min-h-[360px] lg:min-h-[520px]">
            ...
            <img
              src={heroB}
              alt="Poster"
              className="absolute right-6 top-10 w-44 sm:w-56 lg:w-64 rounded-xl shadow-2xl border border-[hsl(230_16%_26%_/_.6)] rotate-6"
            />
            {/* Middle card */}
            <img
              src={heroA}
              alt="Poster"
              className="absolute right-0 top-0 w-48 sm:w-64 lg:w-72 rounded-xl shadow-2xl border border-[hsl(230_16%_26%_/_.6)]"
            />
            {/* Front card */}
            <img
              src={batman}
              alt="Poster"
              className="absolute right-10 bottom-6 w-36 sm:w-48 lg:w-56 rounded-xl shadow-2xl border border-[hsl(230_16%_26%_/_.6)] -rotate-3"
            />
          </div>
        </div>
      </div>
